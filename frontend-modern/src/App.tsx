...
import { SelfUp } from './pages/SelfUp';
...
function App() {
  ...
  return (
    <Router root={RootLayout}>
      ...
      <Route path="/selfup" component={SelfUp} />
      <Route
        path="/settings/*"
...
function AppLayout(props: {
  ...
  const getActiveTab = () => {
    ...
    if (path.startsWith('/selfup')) return 'selfup';
  ...
  const utilityTabs = createMemo(() => {
    ...
    return [
      ...
      },
      {
        ...
        label: 'SelfUp',
        route: '/selfup',
        tooltip: 'Monitor application updates and versions',
        badge: null as 'update' | null,
        count: undefined,
        breakdown: undefined,
        icon: (
